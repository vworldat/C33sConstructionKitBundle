...
class YamlModifier
{
    ...
    public function parseYamlModules($configFile)
    {
        ...
        for ($i = 0; $i < count($lines); ++$i)
        {
            ...
            $matches = array();
            if (preg_match('/^([a-zA-Z0-9]+)\:/', $line, $matches) || preg_match('/^#([a-zA-Z0-9]+)\:/', $line, $matches))
            {
                $module = $matches[1];
    ...
    public function addImportFilenameToImporterFile($importerFile, $filenameToImport)
    {
        ...
        $content = "# Please do not edit this file manually. Manual edits will be lost during c33s:config related commands.\n";
